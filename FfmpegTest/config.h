...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86 --enable-asm --enable-gpl --enable-nonfree --enable-shared --disable-ffprobe --disable-static --disable-x86asm"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2024
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "用于 x86 的 Microsoft (R) C/C++ 优化编译器 19.44.35213 版"
